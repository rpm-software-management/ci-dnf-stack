...
Scenario: Test vars from host
  ...
  Then file "/etc/yum.repos.d/var.repo" should be "present"
  ...
  Then file "/etc/dnf/vars/repo" should be "present"
...
Scenario: Test vars taken from installroot
  ...
  Then file "/dockertesting/etc/yum.repos.d/var.repo" should be "present"
  ...
  Then file "/dockertesting/etc/dnf/vars/repo" should be "present"
