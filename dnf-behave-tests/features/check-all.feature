...
Background: Force installation of an RPM that will cause problems with dependencies, duplicates and obsoletes
  Given I use the repository "dnf-ci-fedora"
   ...
   When I execute "rpm" with args "-i --root={context.dnf.installroot} --nodeps {context.dnf.fixturesdir}/repos/dnf-ci-fedora-updates/x86_64/glibc-2.28-26.fc29.x86_64.rpm"
   Then the exit code is 0
