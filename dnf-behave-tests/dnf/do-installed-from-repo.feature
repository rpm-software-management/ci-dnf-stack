...
Scenario: Upgrade pkgB installed from "from-repo-updates1" and install new dependency
...
Scenario: Test reinstall,upgrade,install; one transaction; transaction fails; package lame skipped - was not installed from "--from-repo-updates1"
