# Tests for the dnf download command with --debuginfo and --debugsource options
...
Scenario: Download debugsource for an existing RPM
  Given I use repository "dnf-ci-fedora-updates" as http
   ...
   Then the exit code is 0
    And stderr contains "zstd-debugsource-0:1.3.6-1.fc29"
    And file sha256 checksums are following
        | Path                                                             | sha256                                                                                                       |
...
Scenario: Download debugsource for all architectures
  Given I use repository "dnf-ci-fedora-updates" as http
   ...
   Then the exit code is 0
    And stderr contains "lz4-debugsource-0:1.8.2-2.fc29"
    And file sha256 checksums are following
        | Path                                                           | sha256                                                                                                       |
...
@xfail
Scenario: Download debugsource with --destdir option
  Given I use repository "dnf-ci-fedora-updates" as http
