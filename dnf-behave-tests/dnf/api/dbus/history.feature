...
Given I use repository "history-recent"
  ...
  """
  # check that the history timestamps were changed correctly
 When I execute dnf with args "history list"
 Then stdout matches line by line
 """
 ID Command line                          Date and time       Action\(s\) Altered
  6 .* 1970-01-01 00:01:00 +1
  5 .* 1970-01-01 00:00:50 +2
  4 .* 1970-01-01 00:00:40 +2
  3 .* 1970-01-01 00:00:30 +1
  2 .* 1970-01-01 00:00:20 +2
  1 .* 1970-01-01 00:00:10 +1
 """
